---
name: flowbite
description: reference index for Flowbite documentation. use when a task involves Flowbite components, installation, framework integration, Tailwind-based UI patterns, JavaScript data attributes, or official component and plugin docs, and you need to jump quickly to the relevant Flowbite documentation page.
---
